...
// view list 
    public function viewList($tble) {
        ...
        while ($result->field_count > $i) {
            ...
            echo '<th>' . ucfirst(str_replace(' id', '', $remp)) . '</th>';
        ...
        while ($row = mysqli_fetch_row($result)) {
            ...
            echo '<td><!-- Button -->
                ...
                <a id="itemrow" name="itemrow" class="btn btn-info" href="index.php?view=item&tbl=' . $tble . '&id=' . $i_row . '">View</a>
...
//viewItem
    public function viewItem($tble, $id, $idCol) {
        global $conn;
        echo '<form class="form-horizontal">
<fieldset>
...
<div class="form-group input-group-sm row">
  <label class="col-md-2 col-form-label" for="textinput"><b>' . ucfirst($remp) . ':</b></label>  
  <div class="col-md-10 m-0">
  <label>' . $rqu[$editmeta->name] . '</label> 
  </div>
</div>';
                }
            }
